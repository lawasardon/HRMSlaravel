            ...
            <div class="card flex-fill comman-shadow">
                ...
                <div class="card-body">
                    {{-- <div class="activity-groups">
                        ...
                        <div class="activity-awards">
                            <div class="award-boxs">
                                <img src="{{ asset('admin/assets/img/icons/award-icon-02.svg') }}" alt="Award">
                            </div>
                            <div class="award-list-outs">
                        ...
                        <div class="activity-awards">
                            <div class="award-boxs">
                                <img src="{{ asset('admin/assets/img/icons/award-icon-03.svg') }}" alt="Award">
                            </div>
                            <div class="award-list-outs">
                        ...
                        <div class="activity-awards mb-0">
                            <div class="award-boxs">
                                <img src="{{ asset('admin/assets/img/icons/award-icon-04.svg') }}" alt="Award">
                            </div>
                            <div class="award-list-outs">
