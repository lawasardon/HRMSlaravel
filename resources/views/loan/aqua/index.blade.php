...
@section('content')
    <div class="content container-fluid" id="aquaLoans">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Acqua Loans</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                        <li class="breadcrumb-item active">Acqua Loans</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <x-modal submitMethod="updateLoanStatus" modalId="editLoanStatus" title="Aqua Loan" submitId="submitEdit"
                            ...
                            <table
                                ...
                                <tbody>
                                    <tr v-for="data in loanList" :key="data.id">
                                        ...
                                        <td>@{{ data.interest }}</td>
                                        <td>@{{ data.total }}</td>
                                        <td>@{{ data.terms_of_loan }} months</td>
...
@push('js')
    <script>
        new Vue({
            ...
            methods: {
                aquaLoansList() {
                    axios.get("{{ route('show.aqua.loans.data') }}")
                        .then(response => {
